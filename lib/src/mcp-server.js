  ...
  try {
    if (msg.method === "initialize") {
      ...
      return reply({
        ...
        ) ? msg.params.protocolVersion : "2024-11-05",
        capabilities: { tools: {} },
    ...
    if (!initialized)
      throw Object.assign(new Error("Initialize first"), { rpcCode: -32e3 });
    ...
    if (msg.method === "tools/call") {
      ...
      try {
        const result = await request(tool.method, args, { timeoutMs: 3e4 });
        return reply({
